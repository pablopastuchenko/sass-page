export const features = [
  {
    ...
    text: "Com o Xora, tarefas tediosas são coisa do passado. A automação e processos inteligentes elevam sua produtividade a novos patamares. É como ter uma xícara extra de café, mas sem a agitação.",
    button: {
  ...
  },
  {
    ...
    title: "Durma tranquilo, nós cuidamos de você",
    text: "A segurança dos seus dados é nossa prioridade. Com criptografia de ponta e controles de privacidade robustos, o Xora ajuda a manter suas informações seguras e trancadas mais forte que Fort Knox.",
    button: {
...
export const details = [
  {
    ...
    title: "Edição de vídeo automatizada por IA",
  },
  {
    id: "1",
...
export const faq = [
  {
    ...
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
    id: "1",
  ...
  {
    id: "2",
    question: "Com que frequência você adiciona novos conteúdos?",
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
    id: "3",
    question: "Qual é a sua política de reembolso?",
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
  ...
  {
    id: "5",
    question: "O que acontece quando estou sem armazenamento?",
    answer:
      "Com certeza! Não só você pode atualizar seu plano a qualquer momento, mas também recebe um desconto proporcional, garantindo o máximo valor para sua assinatura.",
  },
  {
...
export const plans = [
  {
    ...
    features: [
      "100MB de armazenamento em nuvem",
      "100+ templates de prompt",
      "5 projetos",
      "Suporte 24/7",
    ],
  ...
  },
  {
    ...
    priceMonthly: 39,
    priceYearly: 29,
    caption: "Exclusivamente para equipes",
    features: [
      "Todos os recursos do Overdrive",
      "10TB de armazenamento adicional",
...
export const testimonials = [
  {
    ...
    comment:
      "O suporte ao cliente da Xora é incomparável! Eles são como meus super-heróis da tecnologia, sempre lá quando eu preciso.",
  },
  {
    id: "1",
    name: "Mark Erixon",
    ...
    comment:
      "Eu estava cético no começo, mas agora não consigo imaginar nossas operações de conteúdo sem isso. É muito impactante.",
  },
  {
    id: "2",
    name: "Melanie Hurst",
    ...
    comment:
      "Adotar este software foi fácil. Tornou tarefas diárias muito mais simples.",
  },
  {
    id: "3",
    name: "Alicia Barker",
    ...
    comment:
      "O recurso de análises é como ter um contador de fortuna pessoal. Tem sido fundamental para guiar nossas decisões de negócios.",
  },
  {
    id: "4",
    name: "Becky Snider",
    ...
    comment:
      "Mudei para o Xora no mês passado e já estou vendo resultados. Melhor decisão para nossa equipe!",
  },
  {
    id: "5",
    name: "Jim Bradley",
